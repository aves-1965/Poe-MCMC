...
4. Con un número de iteraciones adecuado, el estado final es una buena aproximación al cifrado original
...
### Ejemplo rápido: decodificar

```r
source("decode_simple.R")

# El script descarga automáticamente el corpus de Austen
# y ejecuta el descifrador MCMC con parámetros por defecto
```

### Con múltiples reintentos
...
# Ejecutar
resultados <- run_multiple_chains(n_restarts, n_iterations)
```
...
La cadena necesita suficientes iteraciones para explorar el espacio de estados y acercarse a la distribución objetivo. El número de iteraciones depende de la complejidad del problema y la calidad de la distribución propuesta.
...
- Rojo, Alberto (2013). *El azar en la vida cotidiana*.
...
A los docentes de la cátedra "Modelado & Simulación" que nos presentaron este tema apasionante y nos animaron a publicarlo:

- Prof. Sebastián Castro
- Prof. Ayelén Avila

---

**Estado:** Presentado y Aprobado ✓  
