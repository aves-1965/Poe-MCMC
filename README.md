...
run\_chain() itera a través de estos pasos:
...
resultados \<- run\_multiple\_chains(n\_restarts, n\_iterations, burn\_in)
...
plot\_diagnostics(cadena, burn\_in \= 5000\)
...
Programa TUIA — UNR, Rosario, Argentina

## Agradecimientos

A los docentes de la cátedra “Modelado & Simulación” de la Tecnicatura Universitaria en Inteligencia Artificial”, que nos presentaron este tema apasionante y me animaron a publicarlo. 
